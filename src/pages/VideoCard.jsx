        ...
        <>
            <div>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>
                        {/* copy embed code */}
                        <iframe width={"100%"} height={"400px"} src={`${card?.url}?autoplay=1`} title="Remo - Sirikkadhey Tamil Video | Sivakarthikeyan | Anirudh Ravichander" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </Modal.Body>
